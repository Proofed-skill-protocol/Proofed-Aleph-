...
Typical scores range 55-88. Be specific, not generic.`;
      ...
      const simData: Record<string, typeof result> = {
        frontend: {
          score: 78,
      ...
      result = simData[goal] || simData.frontend;
    }
    ...
    // In production: use ethers.js to call your deployed ProofStorage.sol on Fuji
